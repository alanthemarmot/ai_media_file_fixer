              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                ...
                <div className="mt-4">
                  ...
                  <div className="mt-4 text-sm text-gray-500">
                    ...
                    <p className="mt-2">Need an API key? <a href="https://www.themoviedb.org/signup" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Sign up for a free TMDB account</a> and request an API key.</p>
                  </div>
                </div>
              </div>
            </div>
