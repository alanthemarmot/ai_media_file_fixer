        ...
        <div className="flex gap-2 relative">
          <div className="flex-1 relative">
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 search-input-focus"
              autoComplete="off"
            />
